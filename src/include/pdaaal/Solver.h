...
namespace pdaaal {
    ...
    private:
        ...
        template <typename W>
        static auto _get_trace_looping(const internal::PAutomaton<W,TraceInfoType::Pair>& automaton, AutomatonPath<> path) {
            internal::TraceBack trace_back(automaton, std::move(path));
